...
until kubectl -n m3db get pod m3-cluster-rep0-1 ; do date; sleep 3; echo "waiting to craete m3cb cluster"; done
until kubectl -n m3db wait --for=condition=ready pod/m3-cluster-rep0-1 ; do date; sleep 3; echo "waiting to ready state of m3dbnode"; done
